                ...
                <form method="post" action="connect.php">
                    ...
                    <?php 
                        ...
                        while ($row = $result->fetch_assoc()) {
                            $BMI = floatval($row['BMI']);  // Extract BMI as a float for accurate comparisons
                            echo "<h2 class='res2'>Body Mass Index is: " . $BMI . "<br></h2>"; 
                            echo "<h2 class='res1'>Calories required per day: " . $row['Calories'] . "<br></h2>";
                            break;  // Exit the loop after the first iteration
                        }
                        
                        if ($BMI <= 18.5) {
                            echo "<h2 class='res2' style='font-size:50px;font-weight:bolder;'>You are Underweight</h2>";
                        } else if ($BMI < 25) {
                            echo "<h2 class='res2' style='font-size:50px;font-weight:bolder;'>You are Normalweight</h2>";
                        } else if ($BMI < 30) {
                            echo "<h2 class='res2' style='font-size:50px;font-weight:bolder;'>You are Overweight</h2>";
                        } else {
                            echo "<h2 class='res2' style='font-size:50px;font-weight:bolder;'>You are Obesity</h2>";
                        }
